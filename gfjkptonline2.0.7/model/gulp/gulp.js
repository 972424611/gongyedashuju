function gulpHtml(elem,fileName,callback) {
    var  str1= '<dl class="list_dl">\n' +
        ...
        '            <li class="list_li" onclick="toZhiLiangJianCe()">发电质量</li>\n' +
        ...
        '    <dt class="list_dt">\n' +
        '        <span class="_after"></span>\n' +
        '        <p><span class="glyphicon glyphicon-sort" aria-hidden="true">发用电比较</span></p>\n' +
        '        <i class="list_dt_icon"></i>\n' +
        '    </dt>\n' +
        '    <dd class="list_dd">\n' +
        '        <ul>\n' +
        '            <li class="list_li" onclick="toCompareFaAndYong()">发用电比较</li>\n' +
        '        </ul>\n' +
        '    </dd>\n' +
        '    <dt class="list_dt">\n' +
        '        <span class="_after"></span>\n' +
        '        <p><span class="glyphicon  glyphicon-calendar" aria-hidden="true">历史数据</span></p>\n' +
        '        <i class="list_dt_icon"></i>\n' +
        '    </dt>\n' +
        '    <dd class="list_dd">\n' +
        '        <ul>\n' +
        '            <li class="list_li" onclick="toInverterHistory()">光伏数据</li>\n' +
        '        </ul>\n' +
        '    <dt class="list_dt" id="device">\n' +
        '        <span class="_after"></span>\n' +
    ...
    var  str2= '<nav class="navbar navbar-default header-nav">\n' +
        ...
        var str3 = '<dl class="list_dl">\n' +
            ...
            '    <dd class="list_dd">\n' +
            '        <ul>\n' +
            '            <li class="list_li" onclick="toDeviceManagement()">设备信息</li>\n' +
            '        </ul>\n' +
            '    </dd>\n' +
            '</dl>\n';
        ...
        document.getElementById(elem).innerHTML=flag==='h'?str2:str;
        callback && callback();
}
